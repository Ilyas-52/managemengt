                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-right border-collapse">
                        ...
                        <tbody className="divide-y divide-slate-100 text-xs text-slate-700">
                            {fetchingLogs ? (
                                <tr>
                                    <td colSpan={7} className="p-6 text-center text-slate-400 font-normal">جاري تحميل السجل...</td>
                                </tr>
                            ) : myLogs.length === 0 ? (
                                <tr>
                                    <td colSpan={7} className="p-6 text-center text-slate-400 font-normal">لم تقم بتسجيل أي ساعات إضافية بعد</td>
                                </tr>
                            ) : (
                                myLogs.map((item) => (
